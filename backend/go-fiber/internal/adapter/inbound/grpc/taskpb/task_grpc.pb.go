...
const (
	...
	TaskService_SetTaskDone_FullMethodName = "/task.v1.TaskService/SetTaskDone"
...
type TaskServiceClient interface {
	...
	SetTaskDone(ctx context.Context, in *SetTaskDoneRequest, opts ...grpc.CallOption) (*Task, error)
...
func (c *taskServiceClient) SetTaskDone(ctx context.Context, in *SetTaskDoneRequest, opts ...grpc.CallOption) (*Task, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(Task)
	err := c.cc.Invoke(ctx, TaskService_SetTaskDone_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type TaskServiceServer interface {
	...
	SetTaskDone(context.Context, *SetTaskDoneRequest) (*Task, error)
...
func (UnimplementedTaskServiceServer) SetTaskDone(context.Context, *SetTaskDoneRequest) (*Task, error) {
	return nil, status.Error(codes.Unimplemented, "method SetTaskDone not implemented")
}
...
func _TaskService_SetTaskDone_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: TaskService_SetTaskDone_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
