...
import (
	...
	task "github.com/makifbaysal/boilerplates/backend/go-fiber/internal/core/task"
...
//   - ctx context.Context
//   - t *task.Task
func (_e *Repository_Expecter) Create(ctx interface{}, t interface{}) *Repository_Create_Call {
	return &Repository_Create_Call{Call: _e.mock.On("Create", ctx, t)}
}

func (_c *Repository_Create_Call) Run(run func(ctx context.Context, t *task.Task)) *Repository_Create_Call {
...
func (_c *Repository_Create_Call) RunAndReturn(run func(context.Context, *task.Task) error) *Repository_Create_Call {
	_c.Call.Return(run)
	return _c
}
...
func (_m *Repository) Get(ctx context.Context, id string) (*task.Task, error) {
	ret := _m.Called(ctx, id)
...
func (_c *Repository_Get_Call) Return(_a0 *task.Task, _a1 error) *Repository_Get_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *Repository_Get_Call) RunAndReturn(run func(context.Context, string) (*task.Task, error)) *Repository_Get_Call {
	_c.Call.Return(run)
	return _c
}

// List provides a mock function with given fields: ctx
func (_m *Repository) List(ctx context.Context) ([]*task.Task, error) {
	ret := _m.Called(ctx)
...
func (_c *Repository_List_Call) Return(_a0 []*task.Task, _a1 error) *Repository_List_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *Repository_List_Call) RunAndReturn(run func(context.Context) ([]*task.Task, error)) *Repository_List_Call {
	_c.Call.Return(run)
	return _c
}

// Update provides a mock function with given fields: ctx, t
func (_m *Repository) Update(ctx context.Context, t *task.Task) error {
	ret := _m.Called(ctx, t)
...
//   - ctx context.Context
//   - t *task.Task
func (_e *Repository_Expecter) Update(ctx interface{}, t interface{}) *Repository_Update_Call {
	return &Repository_Update_Call{Call: _e.mock.On("Update", ctx, t)}
}

func (_c *Repository_Update_Call) Run(run func(ctx context.Context, t *task.Task)) *Repository_Update_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(context.Context), args[1].(*task.Task))
	})
	return _c
