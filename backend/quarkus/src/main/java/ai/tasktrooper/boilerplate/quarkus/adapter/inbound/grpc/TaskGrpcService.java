...
import ai.tasktrooper.boilerplate.quarkus.adapter.inbound.grpc.taskpb.DeleteTaskResponse;
...
import ai.tasktrooper.boilerplate.quarkus.adapter.inbound.grpc.taskpb.ListTasksResponse;
...
/** The gRPC sibling of adapter.inbound.rest.TaskResource — same
...
public class TaskGrpcService extends TaskServiceGrpc.TaskServiceImplBase {
    ...
    private static Task toProto(ai.tasktrooper.boilerplate.quarkus.core.task.Task t) {
